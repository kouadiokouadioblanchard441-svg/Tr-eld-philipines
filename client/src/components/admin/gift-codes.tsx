        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
            <Label htmlFor="amount">Montant (GPB)</Label>
                <Input
                  id="amount"
                  type="number"
            ...
            <Card key={giftCode.id} data-testid={`gift-code-item-${giftCode.id}`}>
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold" data-testid={`text-amount-${giftCode.id}`}>{parseFloat(giftCode.amount).toLocaleString()} GPB</span>
                </div>
                <div className="flex justify-between">
