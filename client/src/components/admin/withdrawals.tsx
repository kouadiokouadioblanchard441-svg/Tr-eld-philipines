              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <p className="font-medium text-foreground">{withdrawal.amount.toLocaleString()} GPB</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">Montant net</p>
                    <p className="font-medium text-primary">{withdrawal.netAmount.toLocaleString()} GPB</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">Frais</p>
                    <p className="font-medium text-destructive">{withdrawal.fees.toLocaleString()} GPB</p>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    <p className="text-muted-foreground">Numéro destinataire</p>
                ...
                {withdrawal.status === "pending" && (
                  <div className="flex gap-2">
                    ...
                    >
                      {processingId === withdrawal.id ? <Loader2 className="w-4 h-4 animate-spin" /> : <><Check className="w-4 h-4 mr-1" /> Approuver</>}
                    </Button>
                    <Button
                      size="sm"
                      variant="destructive"
