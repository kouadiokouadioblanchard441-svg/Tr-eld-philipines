...
export default function AdminDashboard({ isSuperAdmin }: AdminDashboardProps) {
    ...
    mutationFn: async () => {
      ...
      if (!response.ok) {
        const result = await response.json();
         throw new Error(result.message || "Erreur lors de la réinitialisation des statistiques");
      }
  ...
  const depositStats = [
    {
      ...
      value: `${stats.totalDeposits.toLocaleString()} GPB`,
      subtitle: `+${stats.todayDeposits.toLocaleString()} GPB aujourd'hui`,
    ...
    },
    {
      ...
      value: `${stats.pendingDeposits.toLocaleString()} GPB`,
  ...
  const withdrawalStats = [
    {
      ...
      value: `${stats.totalWithdrawals.toLocaleString()} GPB`,
      subtitle: `+${stats.todayWithdrawals.toLocaleString()} GPB aujourd'hui`,
    ...
    },
    {
      ...
      value: `${stats.pendingWithdrawals.toLocaleString()} GPB`,
  ...
  const financialStats = [
    {
       title: "Solde total de la plateforme",
      value: `${stats.totalBalance.toLocaleString()} GPB`,
    ...
    {
       title: "Total des gains distribués",
      value: `${stats.totalEarnings.toLocaleString()} GPB`,
    ...
    },
    {
      ...
      value: `${stats.totalCommissions.toLocaleString()} GPB`,
  ...
  const periodStats = appliedDates.start || appliedDates.end ? [
    ...
    },
    {
      ...
      value: `${stats.periodDeposits.toLocaleString()} GPB`,
       subtitle: "Approuvés pendant la période",
      icon: ArrowDownToLine,
    ...
    },
    {
      ...
      value: `${stats.periodWithdrawals.toLocaleString()} GPB`,
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                   ...
                   <p className="text-xs text-muted-foreground">Réinitialiser tous les compteurs</p>
                </div>
              </div>
              <Button 
                variant="destructive" 
      ...
      <Dialog open={showResetDialog} onOpenChange={setShowResetDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Cette action remettra tous les compteurs statistiques à zéro.
              Les données réelles (dépôts, retraits, produits, comptes) ne seront PAS supprimées.
