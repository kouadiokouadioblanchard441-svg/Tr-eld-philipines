...
export default function WithdrawModal({ open, onClose }: WithdrawModalProps) {
  ...
  const withdrawMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      refreshUser();
      toast({ title: "Demande envoyée !", description: "Votre retrait est en attente d'approbation." });
      handleClose();
    },
    onError: (error: any) => {
        ...
        {!canWithdraw ? (
          <div className="space-y-4">
            <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-destructive">Retrait indisponible</p>
          ...
          <div className="space-y-4">
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-foreground">En dehors des heures de retrait</p>
                <p className="text-muted-foreground mt-1">
                   Les retraits sont disponibles de {actualStartHour}:00 à {actualEndHour}:00
