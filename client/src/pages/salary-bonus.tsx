...
export default function SalaryBonusPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: "#F0F2F5" }}>
      ...
      <div className="flex-1 overflow-y-auto bottom-nav-clearance px-4 pt-4 space-y-3">
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(112deg, #FF0000 0%, #C00000 100%)", minWidth: 72 }}
              >
              ...
              <div className="flex-1 px-4 py-4">
                ...
                <button
                  ...
                  style={reached
                    ? { background: "linear-gradient(90deg, #FF0000, #C00000)", color: "#fff" }
