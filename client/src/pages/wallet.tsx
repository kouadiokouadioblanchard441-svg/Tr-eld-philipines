...
const walletSchema = z.object({
  accountName: z.string().min(2, "Le nom du titulaire est obligatoire"),
  accountNumber: z.string().min(8, "Le numéro de compte est obligatoire"),
  paymentMethod: z.string().min(2, "Le mode de paiement est obligatoire"),
});
      ...
      <div className="flex flex-col min-h-full bg-gray-50">
        ...
        <div
          className="flex items-center px-4 py-4"
           style={{ background: "linear-gradient(112deg, #FF0000 0%, #C00000 100%)" }}
        >
          <button
        ...
        <div className="flex-1 bg-white mt-3 mx-4 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-gray-100">
             <p className="text-xs text-gray-400 mb-1">Titulaire du compte</p>
            <input
        ...
        {isLoading ? (
          ...
          wallets.map((wallet) => (
            <div
              ...
              } ${wallet.isDefault ? "border-l-4 border-[#FF0000]" : ""}`}
              ...
              <div className="flex-1 min-w-0">
                ...
                {wallet.isDefault && (
                  <div className="flex items-center gap-1 mt-1">
                    <Shield className="w-3 h-3 text-[#FF0000]" />
                    <span className="text-xs text-[#FF0000] font-medium">Default</span>
                  </div>
                )}
              </div>
