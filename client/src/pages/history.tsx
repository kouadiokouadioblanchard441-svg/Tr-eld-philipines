...
const getStatusInfo = (status: string) => {
  switch (status) {
    ...
    case "processing":
      return { label: "En cours", color: "#d98208" };
    default:
    ...
    <main className="history-page">
      ...
      <div className="history-screen">
        <header className="history-header">
          ...
          <img className="history-brand" src={hsbcLogo} alt="HSBC" />
          ...
          {isLoading ? (
            ...
            balanceEntries.length > 0 ? (
              <div className="history-list">
                ...
                <p className="history-more">Charger davantage</p>
              </div>
            ) : (
