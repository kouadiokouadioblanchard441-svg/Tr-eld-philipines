        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="overflow-x-auto -mx-4 px-4">
            <TabsList className="w-max">
              ...
              <TabsTrigger value="identity-verifications" data-testid="tab-identity-verifications">Identités</TabsTrigger>
          ...
          <TabsContent value="identity-verifications" className="mt-4">
