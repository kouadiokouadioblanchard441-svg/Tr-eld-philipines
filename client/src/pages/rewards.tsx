...
export default function RewardsPage() {
  ...
  const claimMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Felicitations",
        description: "Récompense reçue avec succès !",
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-100">
      <div className="flex-1 overflow-y-auto bottom-nav-clearance">
        ...
        <div className="relative px-4 pt-4 pb-6" style={{ background: "linear-gradient(180deg, #fff0eb 0%, #f5f5f5 100%)" }}>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ backgroundColor: "#FF0000" }}>
        ...
        <div className="px-4 mt-2">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-1 h-5 rounded-full" style={{ backgroundColor: "#FF0000" }} />
